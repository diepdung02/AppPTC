...
export type OutputScreenRouteProp = RouteProp<RootStackParamList, 'OutputScreen'>;

export type OutputListScreenProp = RouteProp<RootStackParamList, 'OutputList'>;
...
export type RootStackParamList = {
  ...
  Mail: undefined;
  SendMail: undefined;
  OutputScreen: { product: Product; productId: number; components: Component[]; productName: string };
