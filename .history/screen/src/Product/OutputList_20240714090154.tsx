...
const OutputList = ({ navigation, route }: { navigation: OutputListNavigationProp; route: OutputListRouteProp }) => {
  const { completedComponents, productName }: { completedComponents: Component[]; productName: string } = route.params;

  // State to store completed components
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.title}>Các thành phần đã hoàn thành của sản phẩm {productName}</Text>
      <FlatList
