...
import { RootStackParamList, Product, Component } from '../../navigator/natigation'; // Ensure correct path to navigation
import COLORS from '../../../constants/Color'; // Ensure correct path to Colors
...
const OutputList = ({ navigation }: { navigation: OutputListNavigationProp }) => {
  ...
  const navigateToDetail = (product: Product) => {
    navigation.navigate('OutputDetail', { productName: product.productName, completedComponents: product.completedComponents });
  };
