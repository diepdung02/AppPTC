...
import { RootStackParamList, Component } from '../../navigator/natigation'; // Đảm bảo đúng đường dẫn đến navigation
...
const OutputScreen = ({ navigation }: { navigation: OutputScreenNavigationProp }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      navigation.navigate('OutputList', { productName, completedComponents: selectedComponents });
    } catch (error) {
