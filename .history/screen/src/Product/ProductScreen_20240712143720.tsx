...
const ProductScreen: React.FC<ProductScreenProps> = ({ navigation }) => {
  ...
  const renderComponent = (component: Component) => (
    <View key={component.id} style={styles.componentItem}>
      ...
      <FontAwesome name={component.isCompleted ? "check-square" : "square-o"} size={20} color="black" />
    </View>
  );
...
Explanation:
Component and Product Types: Defined Component and Product types to include components within each product.
Updated Product Data: Enhanced the products array to include components for each product.
Render Components: Added renderComponent function to render
