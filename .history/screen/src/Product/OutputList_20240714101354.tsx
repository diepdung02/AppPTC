...
import { RootStackParamList, Product } from "../../navigator/navigation"; // Đảm bảo đúng đường dẫn đến navigation
...
const OutputList = ({
  ...
  const { productName } = route.params; // Lấy productName từ route.params
  ...
  const selectProduct = (product: Product) => {
    navigation.navigate("OutputDetail", { product });
  };
