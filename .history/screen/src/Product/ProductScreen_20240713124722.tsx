...
import { RootStackParamList } from '../../navigator/natigation'; // Adjust the path as per your actual structure
import FontAwesome from 'react-native-vector-icons/FontAwesome';
import * as MediaLibrary from 'expo-media-library';
import { WebView } from 'react-native-webview';
import COLORS from '../../../constants/Color'; // Adjust the path as per your actual structure
    ...
    <SafeAreaView style={styles.container}>
      ...
      {!showPdf ? (
        <>
          ...
          />
          <FlatList
            data={products} // Ensure products array is accessible here
