...
type ComponentScreenProps = {
  navigation: StackNavigationProp<RootStackParamList, 'ComponentScreen'>;
  productId: number; // Add any other needed props
};
...
const ComponentScreen: React.FC<ComponentScreenProps> = ({ navigation, productId }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <FlatList
        data={products.find((product) => product.id === productId)?.components || []}
