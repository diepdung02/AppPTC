...
const OutputList: React.FC<OutputListProps> = ({ navigation, route }) => {
  ...
  useEffect(() => {
    updateProductCompletion(completedProducts);
  }, [completedProducts]);
  ...
  const isProductCompleted = (product: Product): boolean => {
    return product.components.every((component) => component.isCompleted);
  };
          ...
          <View>
            ...
            {item.components.map((component, index) => (
              <View
                ...
                style={[
                  styles.productItem,
                  component.isCompleted ? styles.completedProductItem : styles.pendingProductItem,
                ]}
              >
