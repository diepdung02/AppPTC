...
const OutputScreen = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Xóa sản phẩm đã hoàn thành khỏi state selectedComponents
      setSelectedComponents([]);
      ...
      // Cập nhật danh sách components để loại bỏ các thành phần đã gửi
      // Chú ý: Bạn có thể cần cập nhật cách bạn lưu trữ danh sách components để đảm bảo tính nhất quán với ứng dụng của bạn.
      // Ví dụ: components đã cập nhật có thể lưu vào state hoặc cập nhật ngay trong AsyncStorage nếu cần.
    } catch (error) {
