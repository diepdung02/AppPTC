...
import { RootStackParamList } from '../../navigator/navigation'; // Ensure correct path to navigation
import COLORS from '../../../constants/Colors'; // Ensure correct path to COLORS constant
...
type OutputScreenProps = {
  ...
  route: { params: { productId: number } }; // Ensure this is passed correctly from previous screen
};
