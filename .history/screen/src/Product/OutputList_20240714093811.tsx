...
import { RootStackParamList, Component, Product } from '../../navigator/navigation'; // Đảm bảo đúng đường dẫn đến navigation
import COLORS from '../../../constants/Colors'; // Đảm bảo đúng đường dẫn đến Colors
...
const OutputList = ({ navigation }: { navigation: OutputListNavigationProp }) => {
  ...
  const navigateToDetail = (productName: string) => {
    navigation.navigate('OutputDetail', { productName });
  };
