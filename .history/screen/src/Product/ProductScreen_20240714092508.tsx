...
import { RootStackParamList } from '../../navigator/navigation'; // Adjust the import path as per your project structure
import FontAwesome from 'react-native-vector-icons/FontAwesome';
import AsyncStorage from '@react-native-async-storage/async-storage';
import COLORS from '../../../constants/Color';
import { Component, Product } from '../../navigator/natigation'; // Assuming Component and Product types are defined in a separate file
...
const ProductScreen: React.FC<ProductScreenProps> = ({ navigation }) => {
  ...
  const [selectedComponents, setSelectedComponents] = useState<Component[]>([]); // Define selectedComponents state
  ...
  const handleOutputPress = (product: Product) => {
    navigation.navigate('OutputScreen', {
      product: product,
      components: selectedComponents, // Pass selected components to OutputScreen
    });
  };
