...
import { login, LoginResponse } from './api'; // Import hàm login từ api.ts
...
const LoginScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  const handleLogin = async (values: { username: string; password: string }) => {
    try {
      const data: LoginResponse = await login(values.username, values.password);
      if (data.success) { // Giả sử API trả về một field 'success'
