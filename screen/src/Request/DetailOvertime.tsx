...
type ProductDetailScreenRouteProp = RouteProp<RootStackParamList, 'DetailOvertime'>;
type ProductDetailScreenNavigationProp = StackNavigationProp<RootStackParamList, 'DetailOvertime'>;
...
const DetailOvertime: React.FC<Props> = ({ route, navigation }) => {
