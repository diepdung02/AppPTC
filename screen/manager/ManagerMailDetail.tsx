...
type MailDetailScreenNavigationProp = StackNavigationProp<
  ...
  "ManagerMailDetail"
>;
type MailDetailScreenRouteProp = RouteProp<RootStackParamList, "ManagerMailDetail">;
...
const ManagerMailDetail: React.FC<Props> = ({ navigation, route }) => {
...
export default ManagerMailDetail;
