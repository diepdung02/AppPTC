...
type NewsDetailScreenNavigationProp = StackNavigationProp<RootStackParamList, 'NotificationDetail'>;

type NewsDetailScreenRouteProp = RouteProp<RootStackParamList, 'NotificationDetail'>;
