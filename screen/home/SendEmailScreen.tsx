...
import { addEmail } from "../../redux/overtime/mailSlice"; // Điều chỉnh đường dẫn nếu cần thiết
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: COLORS.colorMain, // Đảm bảo COLORS được import đúng từ file Color.js của bạn
  },
  header: {
    flexDirection: "row",
    alignItems: "center",
